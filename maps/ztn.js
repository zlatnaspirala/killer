...
export const mapZTN = {
  ...
  staticGeometry: [
    ...
    { id: 102, name: "North_Portal_Spotlight", type: "Spot Light", isLight: true, lightType: "spot", pos: [0.0, 8.0, -26.0], target: [0.0, 0.4, -30.0], lightDir: [0.0, -0.88, -0.46], scale: [1.0, 1.5, 1.0], color: [0.5, 0.9, 1.0], intensity: 26.0, spotCutoffAngle: 45, spotCutoff: 0.707, outerCutoff: 0.53, roughness: 0.1, metallic: 0.9, collider: "Spot Light Cone", layer: "Layer_Light", trigger: false, badge: "Spot Light", contact: false },
