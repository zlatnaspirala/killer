...
│   └── Engine.cpp
├── examples/
│   ├── 01_glb_character_collision_player.cpp
│   └── 02_fps_shooter_damage_system.cpp
├── index.html
├── main.js
├── CMakeLists.txt
├── build_wasm.sh
...
_This project is an independent, open source focused workbench and is not affiliated with, endorsed by, or sponsored by Google LLC, the SDL project, the Khronos Group, or any of the above-mentioned organizations._
